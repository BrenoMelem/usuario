package com.javanauta.usuario.infraestructure.security;
...
public class JwtUtil {
    ...
    private SecretKey getSecretKey() {
        byte[] key = Base64.getDecoder().decode(secretKey); // Decodificando para um array de bytes
    ...
    public Claims extractClaims(String token) {
        return Jwts.parser()
                ...
                .getPayload(); // Retorna o corpo das claims // Obtém o Payload (corpo) do token, que contém as claims;
    }
